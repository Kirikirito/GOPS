...
exp_name = 'idsim_compare' 
exp_discription = 'comparison and ablation study \
1. based on the latest real exp config \
2. change hidden layers and obs scale to unifty config of multilane and cross \
'
