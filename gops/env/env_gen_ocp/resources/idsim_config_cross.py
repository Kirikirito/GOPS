...
MAP_ROOT_MULTILANE = '/root/idsim-scenarios/idsim-intersection-all-extended/'
pre_horizon = 30
delta_t = 0.1
...
env_config_param_base = {
    ...
    "scenario_reuse": 4,
    "num_scenarios": 260,
    "multilane_scenarios": tuple(range(-2, -1)),
    "scenario_filter_surrounding_selector": '0,30, 60, 90, 120, 150, 180, 210, 240',
    "detect_range": 60,
    "grab_vehicle_in_junction": False,
