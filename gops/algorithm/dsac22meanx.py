...
class DSAC22MEANX(AlgorithmBase):
    ...
    def __compute_loss_q(self, data: DataDict):
        ...
        q1_next, q1_next_std, q1_next_sample = self.__q_evaluate(
            obs2, act2, self.networks.q1_target
        )
        
        q2_next, q2_next_std, q2_next_sample = self.__q_evaluate(
        ...
        target_q2, target_q2_bound, r_soft_2, diff_2 = self.__compute_target_q(
