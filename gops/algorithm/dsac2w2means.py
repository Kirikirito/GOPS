...
__all__=["ApproxContainer","DSAC2W2MEANS"]
import time
...
class DSAC2W2MEANS(AlgorithmBase):
    ...
    def __compute_gradient(self, data: DataDict, iteration: int):
        ...
        loss_q, q1, std1 = self.__compute_loss_q(data)
        loss_q.backward()
    ...
    def __compute_loss_q(self, data: DataDict):
        ...
        weight = 1 * torch.mean(torch.pow(q1_std.detach(), 2))
