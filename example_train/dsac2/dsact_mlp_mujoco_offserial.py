...
#
#  Description: example for dsac + cartpoleconti + mlp + offserial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DSAC22MEANWT2", help="RL algorithm")
    parser.add_argument("--enable_cuda", default=False, help="Enable CUDA")
    parser.add_argument("--seed", type=int, default=2807268183, help="random seed")
    parser.add_argument("--save_folder", type=str, default="/home/wangwenxuan/gops_idp/gops/results/gym_mujono/Reward_100_softplus_std_wt2_0.001")
    ...
    parser.add_argument("--value_max_log_std", type=int, default=3)
