...
#
#  Description: example for trpo + cartpoleconti + cnn + on_serial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_search", type=int, default=25)
    ...
    parser.add_argument("--sample_batch_size", type=int, default=2560)
