...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="ACDPI", help="RL algorithm")
    ...
    parser.add_argument("--policy_std_type", type=str, default="mlp_shared")
    # parser.add_argument("--policy_std_type", type=str, default="mlp_separated")
    parser.add_argument("--policy_lips_init_value", type=float, default=[5])
    parser.add_argument("--policy_lips_auto_adjust", type=bool, default=True)
    parser.add_argument("--policy_lips_learning_rate", type=float, default=1e-4)
    parser.add_argument("--policy_lips_hidden_sizes", type=list, default=[256, 256,256])
    parser.add_argument("--policy_eps", type=float, default=1e-4)
    parser.add_argument("--policy_lambda", type=float, default=1e-8)
    ...
    parser.add_argument("--auto_lambda", type=bool, default=True)
    parser.add_argument("--lambda_learning_rate", type=float, default=1e-5)
    parser.add_argument("--target_multiple", type=float, default=1)#smoothed_sampling_steps
    parser.add_argument("--smoothed_sampling_steps", type=float, default=20)#smoothed_sampling_steps
    parser.add_argument("--noise_level", type=int, default=5)
    parser.add_argument("--noise_switch", type=bool, default=False)
