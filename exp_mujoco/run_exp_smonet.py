...
save_folder = os.path.join(base_path, 'results/exp_smonet')

exp_name = 'exp_smonet_origin_ver' 
exp_discription = 'old training method new feature'
...
run_config = {
    'env_id': ['gym_reacher','gym_walker2d','gym_ant', 'gym_humanoid'],
    'seed':[12345,22345,32345],
    # 'seq_len':[4],
