...
exp_name = 'exp_dssact_02' 
exp_discription = 'new q loss form5 clip 0,10, fix clip bug, not seq_input for q, method 5, smonet4, new weight bias form (constant=10) rel noise0.1 decay 0.01, new buffer random level, freeze policy, fix noise in obs for alg, attn_head num = 8, attn_layer=2, high learning rate, no jacobi reg, weight 1e-4, no any freeze, use norm regulazation, no smooth ratio for compare'
