...
test_configs_file = '/root/gops/idsim_run/test_configs/multilane_tracking_noise_test.json'


conf_list = edict()
conf_list.noise_data = generate_noise_data(test_conf.noise_type, num = 10, scale = 'log', low = 5e-3, high = 5e-1)
conf_list.ini_network_root = [  r"/root/gops/results/idsim/idsim_compare/idsim_multilane_vec/dsact_mlp/12345_2000000_run0",
                                r"/root/gops/results/idsim/idsim_compare/idsim_multilane_vec/dsact_pi/12345_2000000_run0",
                                r"/root/gops/results/idsim/idsim_compare/idsim_multilane_vec/dsact_pismonet/12345_2000000_run0",
                                r"/root/gops/results/idsim/idsim_compare/idsim_multilane_vec/dsac_mlp/12345_2000000_run0",
                                r"/root/gops/results/idsim/idsim_compare/idsim_multilane_vec/sac_mlp/12345_2000000_run0",
                                    ]
